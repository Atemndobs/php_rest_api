...
},{"./config":"src/config.js"}],"src/pagination.js":[function(require,module,exports) {
"use strict";
...
},{"./getData":"src/getData.js"}],"src/router.js":[function(require,module,exports) {
"use strict";
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/getData.js":[function(require,module,exports) {
"use strict";
...
function getData(event) {
  axios.get(_config.baseURL + (0, _router.router)(event)).then(function (response) {
    ...
    var orderByName = document.getElementById("order-by-name");
    var filterWithImages = document.getElementById("filter-with-images-only");
    ...
    (0, _pagination.pagination)(response.data);
    (0, _view.show)(response.data['hydra:member']);
  }).catch(function (error) {
    console.log(error);
  });
}
},{"./view":"src/view.js","./config":"src/config.js","./pagination":"src/pagination.js","./router":"src/router.js","axios":"node_modules/axios/index.js"}],"app.js":[function(require,module,exports) {
"use strict";

var _getData = require("./src/getData");

document.addEventListener("DOMContentLoaded", _getData.getData);
},{"./src/getData":"src/getData.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
