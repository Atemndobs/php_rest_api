 ...
 *
 * @ORM\Entity
 * @ApiResource(iri="http://schema.org/offer", normalizationContext={"groups" = {"read"}},
 *     denormalizationContext={"groups" = {"write"}}, attributes={"pagination_enabled"=false}, itemOperations={
 *     "get",
 *     "delete"={"security"="object.getUser() == user", "security_message"="sorry, but you are the the offer auther."}
 *     })
 *
 */
class Offer
